...
<html>
	...
	<link rel="stylesheet" type="text/css" href="/css/login/kakaoMemberForm.css" />
	...
	<title>HappyPawPet 카카오 회원가입창</title>
	</head>
	<body id="memberForm">
	...
	<section>
		...
		<div class="main">
			...
			<form action="/login/join" name="memFrm" method="post">
				...
				<h4>
					추가적인 정보를 기입해주세요 <span>(* 항목은 필수 항목입니다.)</span>
				</h4>
				<fieldset class="fieldset_class">
					<dl id="nameF">
						...
						<dd>
							<input type="text" id="name" name="name" value="${sessionName }" readonly="readonly"/>
						</dd>
					</dl>
					<dl id="idF">
						<dt>
						...
						<dd>
							<input type="text" id="id" name="id" minlength="4" maxlength="16" value="${sessionId }" readonly="readonly"/>
						</dd>
					</dl>
					<dl id="pwF">
						<dt>
					...
					<dl id="email">
						...
						<dd>
							<input type="text" id="mail_id" name="mail_id" value="${session_email.split('@')[0]}" required /> <span>@</span>
							<input type="text" id="mail_tail" name="mail_tail" required
								value="${session_email.split('@')[1]}" /> <select name="domain_select">
